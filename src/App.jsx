      ...
      <div className={`app-container ${darkMode ? 'dark-mode' : 'light-mode'}`}>
        <nav className="navbar">
          <Link to="/" className="navbar-brand">
            <img src="https://i.pinimg.com/736x/4f/01/4c/4f014c7bde15020464e7fa5b89db8b06.jpg" alt="OurWebsite Logo" className="logo" />
          </Link>
